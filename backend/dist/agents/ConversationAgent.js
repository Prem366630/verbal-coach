...
class ConversationAgent {
     ...
     */
    async respond(userMessage, history, config) {
    ...
    `;
      ...
      `;
        ...
        try {
            return await (0, ai_1.generateAnalysis)(prompt, userMessage, JSON.stringify(history));
        }
        catch (e) {
    ...
    fallbackResponse(userMessage, isShortAnswer, isOffTopic, careerGoal) {
        if (isOffTopic) {
