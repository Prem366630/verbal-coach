...
class EvaluationAgent {
     ...
     */
    async evaluateSession(userId, sessionId, sessionType, sessionMode, transcript) {
    ...
    `;
        ...
        try {
            const result = await (0, ai_1.generateAnalysis)(prompt, transcriptText);
        ...
        if (progress) {
            ...
            await db_1.default.progress.update({
